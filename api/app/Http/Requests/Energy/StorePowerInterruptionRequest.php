...
final class StorePowerInterruptionRequest extends FormRequest
{
    ...
    {
        return [
            'type' => ['required', Rule::enum(InterruptionType::class)],
            'status' => ['nullable', Rule::enum(InterruptionStatus::class)],
            'utility' => ['required', 'string', 'max:120'],
